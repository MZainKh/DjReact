...
const Signup = ({signup, isAuthenticated}) => {
    ...
    return (
        <div className='container mt-5'>
            <h1>Sign Up</h1>
            <p>You have made the right choice to sign up here</p>
            <form onSubmit = {e => onSubmit(e)}>
                ...
                <div className='form-group'>
                    <input className='form-control' type='password' placeholder='Retype Password *' name='re_password' value={re_password} onChange={e => onChange(e)} minLength='6' required />
                </div>
                <button className='btn btn-primary' type='submit'>Sign Up</button>
            </form>
            <p className='mt-3'>Got an account already? what you doing here then? Go <Link to='/login'>Login Here</Link></p>
        </div>
    )
}
