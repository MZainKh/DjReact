...
const Login = ({login, isAuthenticated}) => {
    ...
    return (
        <div className='container mt-5'>
            ...
            <p className='mt-3'>No Account Yet? Useless <Link to='/signup'>Sign Up Here</Link></p>
            <p className='mt-3'>Forgot Your Password? Bruh <Link to='/reset-password'>Click Here</Link></p>
        </div>
    )
}
